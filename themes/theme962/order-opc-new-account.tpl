<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
		<fieldset>
			...
			<p>
            	<a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="openLoginFormBlock" title="{l s='Click here'}">&raquo; {l s='Click here'}</a>
            </p>
        	...
        	<div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_guestCheckout">
                            	<span>
                                	{l s='Guest checkout'}
                                </span>
                            </button>
