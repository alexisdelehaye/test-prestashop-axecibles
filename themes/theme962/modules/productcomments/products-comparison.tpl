    ...
    {foreach from=$list_ids_product item=id_product}
    	<td class="{$classname} comparison_infos" align="center" >
    		{if isset($product_comments[$id_product]) AND $product_comments[$id_product]}
    			<a class="btn btn-default button button-small" href="#" data-id-product-comment="{$id_product|intval}" rel="#comments_{$id_product|intval}" title="{l s='View comments' mod='productcomments'}">
    				<span>
